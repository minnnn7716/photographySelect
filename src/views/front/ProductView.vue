              ...
              <div class="accordion-item border-bottom border-gray-900">
                ...
                <div
                  ...
                  <div class="accordion-body">
                    可以「來店自取」、「超商取貨」與「宅配」。<br>
                    自取可備註環保無包裝，或是輕量僅包裝防塵塑膠套。若是配送則會使用防撞包材妥善的將商品包裝至特規製作的厚紙箱，讓您安心收到喜愛的商品。
                  </div>
                </div>
              </div>
              <div class="accordion-item border-bottom border-gray-900">
                ...
                <div
                  ...
                  data-bs-parent="#accordionQA">
                  <div class="accordion-body">
                    有的，我們也符合網路購物有七天的鑑賞期，但必須保持商品包裝的完整性，當收到商品若不符合期待或是任何原因請與我們聯繫。
                    <br><br>
                    若是商品使用收縮膜包裹，拆除收縮膜後則無法辦理退貨，此類商品歡迎到店面觀賞後再決定是否購買。
                  </div>
                </div>
              </div>
              <div class="accordion-item border-bottom border-gray-900">
                ...
                <div
                  ...
                  >
                  <div class="accordion-body">
                    是我們今年度開始執行的「精選攝影集租借訂閱計畫」，月付 300 元，每個月一號將會收到一本攝影集，
                    在下個月份收到新的攝影集時將前一本攝影集歸還即可。我們希望可以用更平易近人且環保的方式推廣這些美好的片刻。
                    <br><br>
                    若當月閱讀收到的作品後想要直接買下來，便可以使用 6 折的價格購買，如有興趣歡迎與我們聯繫！
                  </div>
                </div>
              </div>
            </div>
